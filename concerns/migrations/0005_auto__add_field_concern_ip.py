...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Concern.ip'
        db.add_column('concerns_concern', 'ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Concern.ip'
        db.delete_column('concerns_concern', 'ip')
